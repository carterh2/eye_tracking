...
for NUMBER_OF_FIXATIONS in range(9, 19):
    num_offset = 8
    ...
    # Remove the first 8 (or other offset) fixations
    fixations = fixations.loc[fixations['Order'] > num_offset]

    run_analysis(fixations, f'{NUMBER_OF_FIXATIONS}-{num_offset}')
